...
using GUMasterData.API.Extensions;
...
namespace GUMasterData
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            GUMasterData.Repository.Configure.ConfigureServices(services, connectionString);
            ...
            services.AddAuthentication(
                ...
                options =>
                {
                    ...
                    options.TokenValidationParameters = new TokenValidationParameters()
                    {
                        ...
                        ValidIssuer = "GUMasterData",
                        ValidAudience = "GUMasterData",
                        ValidateIssuer = true,
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "GUMasterData", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                //To do: After testing need to remove following 
                app.UseExceptionHandler("/error");

                app.UseDeveloperExceptionPage();
                app.UseSwagger();
                //app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GUMasterData v1"));
            }
            else
            {
                app.UseExceptionHandler("/error");
